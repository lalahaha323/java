/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: 2019年05月11日 星期六 15时19分31秒
 ************************************************************************/
...
public class MathTest {
    public static void main(String[] args) {
        ...
        //符号函数，如果参数为0，则返回0；如果参数大于0，返回1.0；如果参数小于0，则返回-1.0
        System.out.println("Math.signum(2.3): " + Math.signum(2.3));
        /*下面时大小相关的运算*/
        //找最大值
        System.out.println("Math.max(2.3, 4.5): " + Math.max(2.3, 4.5));
        //计算最小值
        System.out.println("Math.min(1.2, 3.4): " + Math.min(1.3, 3.4));
        //返回第一个参数和第二个参数之间与第一个参数相邻的浮点数
        System.out.println("Math.nextAfter(1.2, 1.0): " + Math.nextAfter(1.2, 1.0));
        //返回比目标数略大的浮点数
        System.out.println("Math.nextUp(1.2): " + Math.nextUp(1.2));
        //返回一个随机数，改值大于等于0.0且小于1.0
